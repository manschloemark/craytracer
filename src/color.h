...
static inline fcolor fcolor_new(double r, double g, double b) {
	fcolor c = {r, g, b};
	return c;
}

static inline fcolor color_mul(fcolor a, double f) {
	fcolor c = {};
	c.r = a.r*f;
	c.g = a.g*f;
	c.b = a.b*f;
